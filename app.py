...
new_text2_1 = '<p style="font-family:sans-serif; color:Black; font-size: 14px;">1 returns very simple progressions (I-IV or I-V repeating), 3 returns common progressions, and 10 returns more "unusual" progressions.</p>'
